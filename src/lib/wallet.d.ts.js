 ...
 * @property {(tokenName: string, tokenSymbol: string, isLocked: boolean, amountLocked: string, timeLocked: number, initialbuyAmount: BigInt, factoryAddress: string|any, tokenCreationFee?: string|any, metadataUrl?: string) => Promise<String|any>} createToken
