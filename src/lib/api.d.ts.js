 ...
 * @property {(params: import("../service/api/constant").tokenMetaData) => Promise<any>} uploadMetaData - upload metadata on platform only work for solana network
 ...
 * @property {(params: import("../service/api/constant").withdrawalRequest) => Promise<{message: string, withdrawalUid: string}>} withdrawalRequest - create withdraw request
